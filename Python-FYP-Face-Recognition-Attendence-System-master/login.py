...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="Python-FYP-Face-Recognition-Attendence-System-master/images/Download premium image of Pink beige tile texture background illustration by Nunny about pink beige tile texture background illustration, beige distorted geometric square tile texture background, brown dist.jpg")
        ...
        img1=Image.open("Python-FYP-Face-Recognition-Attendence-System-master/Images_GUI/log1.png")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(username='root', password='localhost',host='localhost',database='facial_recognition',port=3306)
