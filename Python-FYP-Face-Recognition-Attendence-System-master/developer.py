...
# This part is image labels setting start 
        # first header image  
        img=Image.open("Python-FYP-Face-Recognition-Attendence-System-master/images/Download premium image of Pink beige tile texture background illustration by Nunny about pink beige tile texture background illustration, beige distorted geometric square tile texture background, brown dist.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="TONN",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        std_b1_1 = Button(bg_img,text="Tahmin",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open("Python-FYP-Face-Recognition-Attendence-System-master/images/Facial Recognition_ All you Need to Know - Algorithm-X Lab.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Thawfiq",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        att_b1_1 = Button(bg_img,text="Omar",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        hlp_b1_1 = Button(bg_img,text="Neha",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
